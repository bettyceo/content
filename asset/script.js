    ...
    with (ctx) {
        ...
        */
        function onPageCreate() {
            ...
            $W("r$inputTextName").set("text","[[HTML]] <input id='inputTextName'" + textAttributes + ">");
            $W("r$inputTextHP").set("text","[[HTML]] <input id='inputTextHP'" + textAttributes + ">");
            $W("r$inputTextWish").set("text","[[HTML]] <input id='inputTextWish'" + textAttributes + ">");
            $W("r$inputTextSign_1").set("text","[[HTML]] <input id='inputTextSign_1'" + textAttributes + ">");
            $W("r$inputTextSign_2").set("text","[[HTML]] <input id='inputTextSign_2'" + textAttributes + ">");
            $W("r$inputTextTree_1").set("text","[[HTML]] <input id='inputTextTree_1'" + textAttributes + ">");
            $W("r$inputTextTree_2").set("text","[[HTML]] <input id='inputTextTree_2'" + textAttributes + ">");
            $W("r$inputTextTop_1").set("text","[[HTML]] <input id='inputTextTop_1'" + textAttributes + ">");
            $W("r$inputTextTop_2").set("text","[[HTML]] <input id='inputTextTop_2'" + textAttributes + ">");
            $W("r$inputTextTreasure_1").set("text","[[HTML]] <input id='inputTextTreasure_1'" + textAttributes + ">");
            $W("r$inputTextTreasure_2").set("text","[[HTML]] <input id='inputTextTreasure_2'" + textAttributes + ">");
            $W("r$inputTextRole_1").set("text","[[HTML]] <input id='inputTextRole_1'" + textAttributes + ">");
            $W("r$inputTextRole_2").set("text","[[HTML]] <input id='inputTextRole_2'" + textAttributes + ">");
            $W("r$inputTextHand_1").set("text","[[HTML]] <input id='inputTextHand_1'" + textAttributes + ">");
            $W("r$inputTextHand_2").set("text","[[HTML]] <input id='inputTextHand_2'" + textAttributes + ">");
            $W("r$inputTextPosition_1").set("text","[[HTML]] <input id='inputTextPosition_1'" + textAttributes + ">");
            $W("r$inputTextPosition_2").set("text","[[HTML]] <input id='inputTextPosition_2'" + textAttributes + ">");
            $W("r$inputTextFigure_1").set("text","[[HTML]] <input id='inputTextFigure_1'" + textAttributes + ">");
            $W("r$inputTextFigure_2").set("text","[[HTML]] <input id='inputTextFigure_2'" + textAttributes + ">");
            ...
            set("$inputTextSign_1",window.document.getElementById("inputTextSign_1"));
            set("$inputTextSign_2",window.document.getElementById("inputTextSign_2"));
            set("$inputTextTree_1",window.document.getElementById("inputTextTree_1"));
            set("$inputTextTree_2",window.document.getElementById("inputTextTree_2"));
            ...
            set("$inputTextTreasure_1",window.document.getElementById("inputTextTreasure_1"));
            set("$inputTextTreasure_2",window.document.getElementById("inputTextTreasure_2"));
            set("$inputTextRole_1",window.document.getElementById("inputTextRole_1"));
            set("$inputTextRole_2",window.document.getElementById("inputTextRole_2"));
            set("$inputTextHand_1",window.document.getElementById("inputTextHand_1"));
            set("$inputTextHand_2",window.document.getElementById("inputTextHand_2"));
            set("$inputTextPosition_1",window.document.getElementById("inputTextPosition_1"));
            set("$inputTextPosition_2",window.document.getElementById("inputTextPosition_2"));
            set("$inputTextFigure_1",window.document.getElementById("inputTextFigure_1"));
            set("$inputTextFigure_2",window.document.getElementById("inputTextFigure_2"));
        ...
        */
        function onTapCheck() {
            ...
            // 이름, 연락처
            if( targetNum == 5 ) {
                if( get("$inputTextName").value !== "" && get("$inputTextHP").value !== "" ) {
                    main.changeState("Layer6");
                } else {
